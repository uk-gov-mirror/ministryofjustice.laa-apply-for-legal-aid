...
module Providers
  module ProceedingMeritsTask
    RSpec.describe InvolvedChildrenController, type: :request do
      ...
      describe 'GET /providers/applications/:id/proceeding_merits_tasks/:application_proceeding_type_id/involved_child' do
        subject { get providers_legal_aid_application_proceeding_merits_task_involved_child_path(legal_aid_application, lead_application_proceeding_type) }
      ...
      describe 'PATCH /providers/applications/:id/proceeding_merits_tasks/:application_proceeding_type_id/involved_child' do
        let(:params) do
          params = involved_children_names.index_with { |_k| 'true' }
          params
        end

        subject { patch providers_legal_aid_application_proceeding_merits_task_involved_child_path(legal_aid_application, lead_application_proceeding_type), params: params }
        ...
        context 'previous selections' do
          let(:update) { patch providers_legal_aid_application_proceeding_merits_task_involved_child_path(legal_aid_application, lead_application_proceeding_type), params: new_params }
